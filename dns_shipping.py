...
for site_id in cluster['site']:
    ...
    while (count < 3):
        ...
        if subprocess.call(['ping', param, '1', site['ip_address']]) == 0:
            ...
            push_dns_dependancies = "rsync " + "-r $WORKSPACE/dns_binding " + site['username'] + "@" + site['ip_address'] + ":/"
            os.system(push_dns_dependancies)

            # offline installations of bindig dependancies
