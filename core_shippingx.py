...
recipients = ["+265998006237", "+265991450316", "+265995246144", "+265992182669", "+265999600511", "+265992277183", "+265995532195"]

#* Get cluster details
cluster = get_xi_data('http://10.44.0.52/sites/api/v1/get_single_cluster/14')
    ...
    while(count < 3):
        ...
        if subprocess.call(['ping', param, '1', site['ip_address']]) == 0:
            ...
            for recipient in recipients:
                msg = "Hi there,\n\nDeployment of CORE to v4.8.1 for " + site['name'] + " completed succesfully.\n\nThanks!\nEGPAF HIS."
                params = {
            ...
            if count == 3:
                for recipient in recipients:
                    msg = "Hi there,\n\nDeployment of CORE to v4.8.1 for " + site['name'] + " failed to complete after several connection attempts.\n\nThanks!\nEGPAF HIS."
                    params = {
                        "api_key": os.getenv('API_KEY'),
                        "recipient": recipient,
                        "message": msg
